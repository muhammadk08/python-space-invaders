...
space_ship2 = pygame.image.load("img/space_ship2.png")
space_ship2 = pygame.transform.scale(space_ship2, (102, 108))
space_ship3 = pygame.image.load("img/space_ship3.png")
